...
if (NOT TensorFlow_FOUND)
  find_path(TensorFlow_INCLUDE_DIR tensorflow/core/public/version.h PATH_SUFFIXES include PATHS ${TENSORFLOW_INC})
  ...
  if (TensorFlow_INCLUDE_DIR)
    ...
    foreach (_ftf_lib IN LISTS _ftf_libs)
      find_library(TensorFlow${_ftf_lib}_LIBRARY NAMES tensorflow${_ftf_lib} PATHS ${TENSORFLOW_DIR})
